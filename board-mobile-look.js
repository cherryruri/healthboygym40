...
(() => {
 ...
 const boot=()=>{
  ...
  stage.innerHTML='<div class="travel-board-hero"><video class="travel-board-video" muted autoplay playsinline loop preload="metadata"></video><div class="travel-board-shade"></div><div class="travel-board-copy"><span></span><h1></h1><p></p><a></a></div><div class="travel-board-dots" aria-label="배너 선택"></div></div><div class="travel-board-search-panel"></div>';
  shell.before(stage);
  ...
  const siteHeader=document.getElementById('site-header');if(siteHeader)hero.prepend(siteHeader);
 ...
 style.textContent='@media(max-width:768px){body.travel-board-mobile-active{background:#fff!important}body.travel-board-mobile-active #site-header#site-header{position:absolute!important;top:0!important;left:0!important;right:0!important;z-index:40!important;height:64px!important;background:linear-gradient(180deg,rgba(0,0,0,.55),transparent)!important;background-color:transparent!important;border:0!important;box-shadow:none!important;opacity:1!important;backdrop-filter:none!important}body.travel-board-mobile-active #site-header .logo a,body.travel-board-mobile-active #site-header .mobile-menu-btn{color:#fff!important;-webkit-text-fill-color:#fff!important}body.travel-board-mobile-active .board-page{padding-top:0!important;background:#fff!important}body.travel-board-mobile-active .board-operation-hero,body.travel-board-mobile-active .desktop-community-hero,body.travel-board-mobile-active .mall-stories,body.travel-board-mobile-active .cinema-top-tabs,body.travel-board-mobile-active .cinema-extras,body.travel-board-mobile-active .mobile-board-nav,body.travel-board-mobile-active .mobile-board-quick-links{display:none!important}.travel-board-mobile{position:relative;display:block;background:#fff;color:#111}.travel-board-hero{position:sticky;top:0;z-index:1;height:clamp(470px,78vh,620px);overflow:hidden;background:#171717}.travel-board-video{position:absolute;inset:0;width:100%;height:100%;display:block;object-fit:cover;object-position:center;background:#171717;transition:transform .45s ease}.travel-board-hero[data-slide="2"] .travel-board-video{transform:scale(1.06)}.travel-board-shade{position:absolute;inset:0;background:linear-gradient(180deg,rgba(0,0,0,.12),rgba(0,0,0,.08) 42%,rgba(0,0,0,.64))}.travel-board-copy{position:absolute;left:30px;right:26px;bottom:82px;z-index:2;color:#fff;text-align:left}.travel-board-copy>span{display:block;margin-bottom:14px;font-size:11px;font-weight:750;letter-spacing:.13em}.travel-board-copy h1{margin:0!important;white-space:pre-line;font-size:clamp(32px,9vw,46px)!important;line-height:1.25!important;letter-spacing:-.055em!important;color:#fff!important;text-align:left!important}.travel-board-copy p{margin:14px 0 22px!important;font-size:15px!important;line-height:1.65!important;color:rgba(255,255,255,.88)!important;text-align:left!important}.travel-board-copy a{display:inline-flex;align-items:center;min-height:44px;padding:0 18px;border-radius:24px;background:#fff;color:#151515!important;font-size:13px;font-weight:700;text-decoration:none}.travel-board-dots{position:absolute;left:50%;bottom:48px;z-index:3;display:flex;gap:10px;transform:translateX(-50%)}.travel-board-dots button{width:8px;height:8px;padding:0;border:0;border-radius:50%;background:rgba(255,255,255,.48)}.travel-board-dots button[aria-pressed=true]{background:#fff;transform:scale(1.18)}.travel-board-search-panel{position:relative;z-index:5;margin-top:-72px;padding:42px 24px 28px;border-radius:38px 38px 0 0;background:#fff;box-shadow:0 -12px 32px rgba(0,0,0,.12);animation:travelPanelRise .78s cubic-bezier(.22,.8,.28,1) both;will-change:transform}.travel-board-search-panel>p{display:none!important}.travel-board-search-panel .board-search-field{position:relative!important;display:block!important;width:100%!important;margin:0!important}.travel-board-search-panel #boardSearch{display:block!important;width:100%!important;height:58px!important;padding:0 50px 0 20px!important;border:1px solid #ddd!important;border-radius:30px!important;background:#fff!important;color:#222!important;font-size:15px!important;box-shadow:none!important}.travel-board-search-panel .board-search-field i{display:block!important;position:absolute!important;right:20px!important;top:50%!important;z-index:2!important;transform:translateY(-50%)!important;color:#222!important;font-size:18px!important;pointer-events:none!important}@keyframes travelPanelRise{from{transform:translateY(110px)}to{transform:translateY(0)}}.travel-board-mobile+.board-content-shell{position:relative;z-index:6;padding-top:8px!important}.travel-board-mobile+.board-content-shell .board-bottom{justify-content:flex-end!important}.travel-board-mobile+.board-content-shell .board-toolbar{padding-top:0!important}}';
