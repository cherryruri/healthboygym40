(() => {
 ...
 if(!['infoboard','request','teen'].includes(cp.get('board'))&&cp.get('category')!=='request')return;
  ...
  function sync() {
    ...
    if (search) {search.placeholder = '공지와 게시글을 검색해 보세요';search.style.setProperty('border','0','important');search.style.setProperty('border-bottom','0','important');search.style.setProperty('border-bottom-width','0','important');search.style.setProperty('border-bottom-style','none','important');search.style.setProperty('box-shadow','none','important');}
    const decorate = () => {
...
(() => {
 const media=matchMedia('(min-width:0px)');
 const boot=()=>{
  ...
  const searchInput=document.getElementById('boardSearch');if(searchInput){searchInput.style.setProperty('border','0','important');searchInput.style.setProperty('border-bottom','0','important');searchInput.style.setProperty('border-bottom-width','0','important');searchInput.style.setProperty('border-bottom-style','none','important');searchInput.style.setProperty('box-shadow','none','important');}
 ...
 style.textContent='@media(min-width:0px){body.travel-board-mobile-active{background:#fff!important}body.travel-board-mobile-active #site-header#site-header{position:fixed!important;top:0!important;left:0!important;right:0!important;z-index:10000!important;height:64px!important;background:transparent!important;background-color:transparent!important;border:0!important;box-shadow:none!important;opacity:1!important;backdrop-filter:none!important}body.travel-board-mobile-active:not(.menu-open) #site-header .navbar{background:transparent!important;background-color:transparent!important;border:0!important;box-shadow:none!important;backdrop-filter:none!important;-webkit-backdrop-filter:none!important}body.travel-board-mobile-active #site-header .logo a,body.travel-board-mobile-active #site-header .mobile-menu-btn{color:#fff!important;-webkit-text-fill-color:#fff!important}body.travel-board-mobile-active .board-page{position:relative;z-index:2;width:100%!important;max-width:none!important;margin:0!important;padding:0!important;background:transparent!important}body.menu-open .travel-board-hero{z-index:9999!important;overflow:visible!important}body.menu-open #site-header#site-header{position:fixed!important;inset:0 0 auto 0!important;z-index:10000!important}body.menu-open #site-header .mobile-side-menu{max-height:calc(100svh - 64px)!important;overflow-y:auto!important}body.travel-board-mobile-active .board-operation-hero,body.travel-board-mobile-active .desktop-community-hero,body.travel-board-mobile-active .mall-stories,body.travel-board-mobile-active .cinema-top-tabs,body.travel-board-mobile-active .cinema-extras,body.travel-board-mobile-active .mobile-board-nav,body.travel-board-mobile-active .mobile-board-quick-links{display:none!important}.travel-board-mobile{position:relative;left:50%;width:100vw!important;max-width:none!important;margin-left:0!important;transform:translateX(-50%);padding-top:clamp(470px,78vh,620px);display:block;background:transparent;color:#111}.travel-board-hero{position:fixed;top:-72px;left:0;right:0;z-index:1;width:100%;height:calc(clamp(470px,78vh,620px) + 72px);overflow:hidden;background:#171717}.travel-board-video{position:absolute;inset:0;width:100%;height:100%;display:block;object-fit:cover;object-position:center;background:#171717;transition:transform .45s ease}.travel-board-hero[data-slide="2"] .travel-board-video{transform:scale(1.06)}.travel-board-shade{position:absolute;inset:0;background:linear-gradient(180deg,rgba(0,0,0,.12),rgba(0,0,0,.08) 42%,rgba(0,0,0,.64))}.travel-board-copy{position:absolute;left:30px;right:26px;bottom:82px;z-index:2;color:#fff;text-align:left}.travel-board-copy>span{display:block;margin-bottom:14px;font-size:11px;font-weight:750;letter-spacing:.13em}.travel-board-copy h1{margin:0!important;white-space:pre-line;font-size:clamp(32px,9vw,46px)!important;line-height:1.25!important;letter-spacing:-.055em!important;color:#fff!important;text-align:left!important}.travel-board-copy p{margin:14px 0 22px!important;font-size:15px!important;line-height:1.65!important;color:rgba(255,255,255,.88)!important;text-align:left!important}.travel-board-copy a{display:inline-flex;align-items:center;min-height:44px;padding:0 18px;border-radius:24px;background:#fff;color:#151515!important;font-size:13px;font-weight:700;text-decoration:none}.travel-board-dots{position:absolute;left:50%;bottom:48px;z-index:3;display:flex;gap:10px;transform:translateX(-50%)}.travel-board-dots button{width:8px;height:8px;padding:0;border:0;border-radius:50%;background:rgba(255,255,255,.48)}.travel-board-dots button[aria-pressed=true]{background:#fff;transform:scale(1.18)}.travel-board-content{position:relative;z-index:6;width:100%;margin-top:-72px;border-radius:42px 42px 0 0;background:#fff;box-shadow:0 -12px 32px rgba(0,0,0,.12);animation:travelPanelRise .78s cubic-bezier(.22,.8,.28,1) both;will-change:transform;overflow:hidden}.travel-board-search-panel{position:relative;padding:42px 24px 28px;background:#fff}.travel-board-search-panel>p{display:none!important}.travel-board-search-panel .board-search-field{position:relative!important;display:block!important;width:100%!important;height:56px!important;margin:0!important;border:1px solid #d5d5d5!important;border-radius:999px!important;background:#fff!important;background-image:none!important;box-shadow:none!important;box-sizing:border-box!important;overflow:hidden!important}.travel-board-search-panel .board-search-field:before,.travel-board-search-panel .board-search-field:after{display:none!important}body.travel-board-mobile-active .travel-board-search-panel #boardSearch{display:block!important;width:100%!important;height:54px!important;padding:0 54px 0 20px!important;border:0!important;border-width:0!important;border-style:none!important;border-color:transparent!important;border-bottom:0!important;border-radius:999px!important;background:transparent!important;background-image:none!important;color:#222!important;font-size:15px!important;box-shadow:none!important;outline:0!important;-webkit-appearance:none!important;appearance:none!important}.travel-board-search-panel .board-search-field i{display:none!important}.travel-search-icon{position:absolute;right:19px;top:50%;z-index:3;width:22px;height:22px;display:grid;place-items:center;transform:translateY(-50%);color:#202020;pointer-events:none}.travel-search-icon svg{width:22px;height:22px;display:block}html body.travel-board-mobile-active .travel-board-mobile .travel-board-search-panel #boardSearch#boardSearch#boardSearch{border:0!important;border-bottom:0!important;border-bottom-width:0!important;border-bottom-style:none!important;box-shadow:none!important}body.travel-board-mobile-active #site-header{display:none!important}body.travel-board-mobile-active .site-top-button,body.travel-board-mobile-active .site-phone-button{display:none!important}.travel-quick-dock{position:fixed;right:18px;bottom:18px;z-index:12000;display:flex;flex-direction:column;align-items:center;gap:10px}.travel-quick-actions{display:flex;flex-direction:column;gap:10px;pointer-events:none}.travel-quick-actions a,.travel-quick-toggle,.travel-quick-phone{width:54px;height:54px;border:0;border-radius:50%;display:grid;place-items:center;text-decoration:none;box-shadow:0 8px 22px rgba(0,0,0,.18)}.travel-quick-actions a{background:#f15b47;color:#fff;opacity:0;transform:translateY(22px) scale(.72);transition:opacity .25s ease,transform .38s cubic-bezier(.22,1,.36,1)}.travel-quick-actions a:nth-child(2){transition-delay:.04s}.travel-quick-actions a:nth-child(1){transition-delay:.08s}.travel-quick-dock.is-open .travel-quick-actions{pointer-events:auto}.travel-quick-dock.is-open .travel-quick-actions a{opacity:1;transform:none}.travel-quick-toggle{background:#ffbec6;color:#111;font-size:38px;font-weight:300;line-height:1;cursor:pointer}.travel-quick-toggle span{display:block;transition:transform .32s ease}.travel-quick-dock.is-open .travel-quick-toggle span{transform:rotate(45deg)}.travel-quick-phone{background:#111;color:#fff}.travel-quick-dock svg{width:25px;height:25px;display:block}@keyframes travelPanelRise{from{transform:translateY(110px)}to{transform:translateY(0)}}.travel-board-content>.board-content-shell{position:relative;z-index:6;background:#fff;padding-top:8px!important}.travel-board-content>.board-content-shell .board-bottom{justify-content:flex-end!important}.travel-board-content>.board-content-shell .board-toolbar{padding-top:0!important}@media(min-width:769px){body.travel-board-mobile-active #site-header#site-header{display:block!important;position:fixed!important;top:0!important;left:0!important;right:0!important;z-index:10000!important;height:80px!important;background:#050505!important;background-color:#050505!important}body.travel-board-mobile-active #site-header .navbar{display:flex!important;background:#050505!important;background-color:#050505!important;border:0!important;box-shadow:none!important}.travel-board-mobile{padding-top:720px}.travel-board-hero{top:-80px;height:800px}.travel-board-copy{left:max(64px,calc((100vw - 1200px)/2));right:auto;bottom:118px;width:min(620px,48vw)}.travel-board-copy h1{font-size:58px!important;line-height:1.14!important}.travel-board-copy p{font-size:17px!important}.travel-board-dots{bottom:66px}.travel-board-content{margin-top:-92px;border-radius:54px 54px 0 0}.travel-board-search-panel{padding:56px 40px 34px}.travel-board-search-panel .board-search-field{max-width:760px;margin:0 auto!important}.travel-board-content>.board-content-shell{width:min(1200px,calc(100% - 64px))!important;max-width:1200px!important;margin:0 auto!important;padding:34px 0 80px!important}.travel-quick-dock{right:32px;bottom:28px}.travel-quick-actions a,.travel-quick-toggle,.travel-quick-phone{width:58px;height:58px}}}';
 document.head.append(style);
 if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',boot,{once:true});else boot();
})();
;(() => {
 const style=document.createElement('style');
 style.textContent='@media(min-width:769px){body.travel-board-mobile-active .travel-quick-dock{display:none!important}body.travel-board-mobile-active .travel-board-content>.board-content-shell{display:block!important;width:calc(100vw - 64px)!important;max-width:1200px!important;min-width:0!important;box-sizing:border-box!important;margin-left:auto!important;margin-right:auto!important;left:auto!important;right:auto!important;transform:none!important}body.travel-board-mobile-active .travel-board-content>.board-content-shell>*{max-width:100%!important;min-width:0!important;box-sizing:border-box!important}body.travel-board-mobile-active .mall-stories{display:block!important;width:100%!important;max-width:1200px!important;margin:0 auto 54px!important}body.travel-board-mobile-active .mall-story-grid{width:100%!important}body.travel-board-mobile-active .site-top-button,body.travel-board-mobile-active .site-phone-button{display:grid!important}}';
 document.head.append(style);
})();

;(() => {
 const center=()=>{if(!matchMedia('(min-width:769px)').matches)return;const shell=document.querySelector('.travel-board-content > .board-content-shell');if(!shell)return;[['display','block'],['width','calc(100vw - 64px)'],['max-width','1200px'],['min-width','0'],['box-sizing','border-box'],['margin-left','auto'],['margin-right','auto'],['left','auto'],['right','auto'],['transform','none']].forEach(([p,v])=>shell.style.setProperty(p,v,'important'));};
 const run=()=>{center();setTimeout(center,350);setTimeout(center,1000)};
