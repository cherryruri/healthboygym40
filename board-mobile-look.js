...
(() => {
 ...
 const boot=()=>{
  ...
  stage.innerHTML='<div class="travel-board-hero"><video class="travel-board-video" muted autoplay playsinline loop preload="metadata"></video><div class="travel-board-shade"></div><div class="travel-board-copy"><span></span><h1></h1><p></p><a></a></div><div class="travel-board-dots" aria-label="배너 선택"></div></div><div class="travel-board-search-panel"><p>공지와 게시글을 검색해 보세요</p></div>';
  shell.before(stage);
