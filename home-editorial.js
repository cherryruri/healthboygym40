...
aiVideo.addEventListener('ended',advanceAi);aiButton.addEventListener('click',()=>{aiState.paused=!aiState.paused;syncAiPlayback();});document.addEventListener('visibilitychange',syncAiPlayback);
